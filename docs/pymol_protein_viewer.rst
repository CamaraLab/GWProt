...
This module generates Pymol scene files files (.pse) which require the Pymol GUI application to be viewed. This can be downloaded from the [Pymol website](https://www.pymol.org).
