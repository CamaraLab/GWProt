...
#slight modifications/debugging by Elijah Gunther
'''
...
def tmalign(mobile, target, args='', exe='/home/elijah/pymol/bin/TMalign', ter=0, transform=1, object=None, quiet=0, return_alignment = False):
    '''
DESCRIPTION
